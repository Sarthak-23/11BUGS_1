...
const UserSchema = mongoose.Schema({
  ...
  handles: {
    ...
    codechef: { type: String, require: true, default: "" },
    codeforces: { type: String, require: true, default: "" },
  },

  // Profile Scores
  scores: {
    github: { type: Number, require: true, default: 0 },
    codechef: { type: Number, require: true, default: 0 },
    codeforces: { type: Number, require: true, default: 0 },
  },
